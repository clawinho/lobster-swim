...
export const manifest = {
    id: 'lobster',
    name: 'Lobster',
    description: 'Player character with tail physics. v005 adds stage-aware baby/adult forms.',
    category: 'hero',
    tags: [],
    configKey: 'player',
};
...
export const versions = [
    ...
    {
        meta: { version: '005a', name: 'Baby (Level 1)', current: true },
        preview: (ctx, w, h, frame, state) => {
            const x = w / 2, y = h / 2;
    ...
    {
        meta: { version: '005b', name: 'Adult (Level 2+)', current: true },
        preview: (ctx, w, h, frame, state) => {
            const x = w / 2, y = h / 2;
