 ...
 */
import { render as renderGoldenFish } from "./versions/GoldenFish.v002.js";
...
export class GoldenFish {
    ...
    render(ctx) {
        renderGoldenFish(ctx, this.x, this.y, this.animTime, this.size, this.direction, GoldenFish.SHIMMER_COUNT);
    }
